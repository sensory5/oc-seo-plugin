<?php return [
    ...
    'settings' => [
        ...
        'tab_og' => [
            ...
            'image_comment' => 'The open graph image to use',
            'enable_image_size' => 'Set image sizes',
            'enable_image_size_comment' => 'Set specific og:image width and height',
            'image_width' => 'Image Width for Open Graph',
            'image_width_comment' => 'The open graph image width in pixels to use',
            'image_height' => 'Image Height for Open Graph',
            'image_height_comment' => 'The open graph image height in pixels to use'
        ],
        'tab_twitter' => [
            'label' => 'Twitter Card',
            'twitter' => 'Use Twitter Card',
            'twitter_comment' => 'Enable Twitter Card Tags',
            'creator' => 'Creator name',
            'creator_comment' => 'The twitter @username',
            'card' => 'Card Type for Twitter Card',
            'card_comment' => 'The card type (summary view or summary with large image)',
            'image' => 'Image for Twitter Card',
            'image_comment' => 'The twitter card image to use',
        ],
    ],
    'component' => [
        'meta' => [
